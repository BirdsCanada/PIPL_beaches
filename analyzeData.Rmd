...
mp4<-lm(avg_productivity_all ~ BeachArea_km + beach_width + Length_km + parkArea + bufferPop_km2 + Border_road + tot_area_km_Beach + developedLand + Region, data = mod.data.p)
...
sjPlot::tab_model(mb1, mf1, show.aic = TRUE)
```
