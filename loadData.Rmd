...
<<<<<<< HEAD
-I have no idea what's going on with goose (indian) point, and goose and burks point?? Are these the same site??? Goose (Indian) Point is half of Goose and Burks point
...
beachArea<-beachArea %>% 
  rename(Description = 2) %>% #column name typo
